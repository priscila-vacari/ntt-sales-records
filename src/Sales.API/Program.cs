    ...
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            try
            {
                ...
                #region Rebus
                //builder.Services.AddRebus(configure => configure.Transport(t => t.UseRabbitMq("amqp://guest:guest@localhost", "sales_queue")));
                ...
                builder.Services.AddValidatorsFromAssemblyContaining<SaleRequestModelValidator>();
                builder.Services.AddValidatorsFromAssemblyContaining<SaleItemRequestModelValidator>();
